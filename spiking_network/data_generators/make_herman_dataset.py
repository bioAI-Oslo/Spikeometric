...
def make_herman_dataset(n_neurons, n_sims, n_steps, data_path, max_parallel, firing_rate):
    ...
    for batch_idx, data in enumerate(data_loader):
        ...
        stim = RegularStimulation(targets=0, strengths=1, duration=n_steps, rates=0.2, temporal_scales=2, n_neurons=data.num_nodes)
